...
#
#     PHX_SERVER=true bin/spotify_re_discoverer start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :spotify_re_discoverer, SpotifyReDiscovererWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :spotify_re_discoverer, SpotifyReDiscoverer.Mailer,
